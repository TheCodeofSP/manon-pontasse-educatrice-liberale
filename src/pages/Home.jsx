...
export default function Home() {
  ...
  const secondaryHref = ctaSecondary?.href ?? "/mon-approche";
        ...
        <div className="home__content">
          ...
          <section className="home__intro">
            ...
            <div className="home__introText">
              ...
              <div className="home__profile reveal" style={{ "--delay": "160ms" }}>
              ...
              >
                {intro?.title && <h2 className="home__panelTitle">{intro.title}</h2>}
