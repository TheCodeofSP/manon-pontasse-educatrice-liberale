...
export default function NotFound() {
  ...
  return (
    <>
      ...
      <div className="nf">
        <div className="nf__content">
          <div className="nf__card reveal reveal--up" style={{ "--delay": "0ms" }}>
            <p className="nf__code" aria-hidden="true">
              404
            </p>

            <h1 className="nf__title">{t("notFound.title", "Page introuvable")}</h1>

            <p className="nf__text">{t("notFound.text", "Cette page n’existe pas.")}</p>
