...
export default function Informations() {
  const { node, isLoading, error } = useContent();
  ...
  const linkSections = Array.isArray(usefulLinks?.sections) ? usefulLinks.sections : [];
  ...
  const deficiencyParagraphs = Array.isArray(deficiency?.paragraphs)
    ? deficiency.paragraphs
    : [];

  const associatedItems = Array.isArray(associated?.items) ? associated.items : [];
      ...
      <div className="info">
        <div className="info__container">
          ...
          <header className="info__hero">
            <h1 className="info__title reveal reveal--up" style={{ "--delay": "0ms" }}>
              {intro?.title}
            </h1>
          ...
          <div className="info__layout">
            ...
            <div className="info__content">
              ...
              >
                ...
                {associated?.intro && <p className="info__p">{associated.intro}</p>}
              ...
              <section
                ...
                style={{ "--delay": "0ms" }}
              >
                <h2 className="info__h2">{usefulLinks?.title ?? "Ressources"}</h2>
                      ...
                      <div className="info__linksGrid" role="list">
                        {(sec?.items ?? []).map((it, idx) => (
                          ...
                          >
                            ...
                            {it?.source && (
                              <span className="info__linkSource">{it.source}</span>
                            )}
