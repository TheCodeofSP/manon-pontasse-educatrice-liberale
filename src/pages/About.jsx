    ...
    <>
      ...
      <div className="about">
        <div className="about__content">
          ...
          {/* Présentation */}
          <section className="about__section" aria-labelledby="about-presentation">
            <article
            ...
            >
              <div className="about__presentationHeader">
                ...
                <div className="about__presentationHeaderText">
                  <h2 className="about__h2 about__h2--center" id="about-presentation">
                    {presTitle}
                  </h2>
          ...
          <section className="about__cta" aria-label="Contact">
            <div className="about__ctaCard reveal" style={{ "--delay": "120ms" }}>
