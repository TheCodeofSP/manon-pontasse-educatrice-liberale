...
export default function FloatingActions({
  ...
  const ariaContact = useMemo(() => contactLabel || "Me contacter", [contactLabel]);

  return (
    <div className="floating-actions" role="region" aria-label="Actions rapides">
      {/* Scroll to top */}
      <button
        type="button"
      ...
      >
        <svg className="floating-actions__icon" viewBox="0 0 24 24" aria-hidden="true">
          <path d="M20 2H4a2 2 0 0 0-2 2v16l4-3h14a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2Z" />
        </svg>

        <span className="floating-actions__label">{contactLabel}</span>
      </Link>
    </div>
  );
}
